...
def digit_predict(model_name):
    ...
    img_1 = [float(i) for i in img_1]
    if model_name == "svm":
        model = load(f'./models/svm_gamma:1_C:10.joblib')
    elif model_name == 'tree':
        model = load(f'./models/M23CSA014_tree_max_depth:10.joblib')
    elif model_name == 'lr':
        model = load(f'./models/M23CSA014_lr_solver:liblinear.joblib')
